%% *Method 3: SWT-SVD with Arnold Transform and Fuzzy Logic*
...
excelFileName = 'audio_watermarking3_results.xlsx';
%%
% Define the different audio options in a struct
audioOptions = struct(...
    'Male',        struct('original', 'Male Voice.wav',        'watermarkaudio', 'Reconstructed_Male3.wav',       'segmentDuration', 2), ...
    'Female',      struct('original', 'Female Voice.wav',      'watermarkaudio', 'Reconstructed_Female3.wav',     'segmentDuration', 2), ...
    'Classical',   struct('original', 'Classical.wav',         'watermarkaudio', 'Reconstructed_Class3.wav',      'segmentDuration', 1), ...
    'Electronic',  struct('original', 'Electronic.wav',        'watermarkaudio', 'Reconstructed_Elec3.wav',       'segmentDuration', 1), ...
    'Rock',        struct('original', 'Rock.wav',              'watermarkaudio', 'Reconstructed_Rock3.wav',       'segmentDuration', 1), ...
    'Jazz',        struct('original', 'Jazz.wav',              'watermarkaudio', 'Reconstructed_Jazz3.wav',       'segmentDuration', 1), ...
    'Pop',         struct('original', 'Pop.wav',               'watermarkaudio', 'Reconstructed_Pop3.wav',        'segmentDuration', 1) ...
);
...
for idx = 1:length(audioFields)
    ...
    baseFolderPath='C:\Users\Jem\Desktop\Audio Watermarking\Method3\';
    ...
    watermarkaudio = fullfile('C:\Users\Jem\Desktop\Audio Watermarking\Method3', audioData.watermarkaudio);
